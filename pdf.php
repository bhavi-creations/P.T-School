...
<body>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-6 d-flex flex-column justify-content-center">
                        <div class="footer-info d-block">
                            <a href="index.php" class="logo me-auto">
                                <img src="assets/img/slide/logo_trans.png" class="img-fluid" alt="" />
                            </a>
                        </div>
                    </div>
                ...
                <div class="row pt-4">
                    <div class="col-xl-8 col-lg-9 col-md-12 col-12">
                        <div class="footer-widget__copyright">
                            <p class="mini_text" style="color: #ffffff"> All Rights Reserved. Designed & Developed by
    ...
    <a href="https://api.whatsapp.com/send?phone=91999999" style="color: #fff" class="whatsapp-link" target="_blank">
